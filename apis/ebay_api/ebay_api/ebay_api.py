...
from apis.ebay_api.ebay_api.core.ebay_category import EbayCategory
from apis.ebay_api.ebay_api.core.ebay_token_api import EbayTokenApi
from apis.ebay_api.ebay_api.core.ebay_product import EbayProduct
...
class EbayApi(BaseEbayApi):
    ...
    def get_all_product_ids(self, category_name_candidate, filter_product, q) -> str:
        ...
        try:
            ...
            for category_id in category_id_dict.keys():
                self.products_list.append(self.ebay_product.get_product_ids_with_category_id(category_id=category_id, filter_product=filter_product, q=q))
    ...
    def get_all_data_of_product_with_product_id_from_products_list(self) -> str:
        ...
        try:
            ...
            self.csv.operation(mode="w", file_name="ebay_product_detail.csv", data=self.product_detail_list)
...
def test():
    EbayApi().get_all_product_ids(category_name_candidate="Sonstige Sensoren", filter_product= "conditions:{NEW},deliveryCountry:DE", q="Lambdasonde")
