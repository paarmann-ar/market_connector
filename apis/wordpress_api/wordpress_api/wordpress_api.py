...
from apis.wordpress_api.wordpress_api.core.wordpress_users import WordpressUsers
from apis.wordpress_api.wordpress_api.core.wordpress_media import WordpressMedia
...
class WordpressApi(BaseWordpressApi):
    ...
    def upload_media_models(self, media_models:list[WordpressMediaModel]) -> str:
